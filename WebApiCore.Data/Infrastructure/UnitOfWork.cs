...
namespace WebApiCore.Services.Infrastructure
{
    public class UnitOfWork : IUnitOfWork
    {
        public ICategoryRepository CategoryRepository => throw new NotImplementedException();

        public IPhotoRepository PhotoRepository => throw new NotImplementedException();

        //public ITagRepository TagRepository => throw new NotImplementedException();

        IRepository<Tag> IUnitOfWork.TagRepository => throw new NotImplementedException();
